...
export default function ReportCard({link, title, description}: Props){
    return(
        <div className=" flex flex-col gap-1 cursor-pointer h-full bg-white p-2 md:p-4 rounded-2xl shadow-gray-200 shadow-md hover:shadow-gray-400 transition-all">
            ...
            <div className="">
                <h1 className="mt-1 text-blue text-[10px] sm:text-sm md:text-base font-upper">{title}</h1>
